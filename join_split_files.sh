...
cat vendor/lib64/libarcsoft_hdr_raw.so.* 2>/dev/null >> vendor/lib64/libarcsoft_hdr_raw.so
rm -f vendor/lib64/libarcsoft_hdr_raw.so.* 2>/dev/null
cat vendor/lib64/libarcsoft_portrait_hdr_raw.so.* 2>/dev/null >> vendor/lib64/libarcsoft_portrait_hdr_raw.so
rm -f vendor/lib64/libarcsoft_portrait_hdr_raw.so.* 2>/dev/null
...
cat vendor/lib64/mt6878/libaibc_tuning.so.* 2>/dev/null >> vendor/lib64/mt6878/libaibc_tuning.so
rm -f vendor/lib64/mt6878/libaibc_tuning.so.* 2>/dev/null
cat vendor/lib64/mt6878/libaibc_tuning_p2.so.* 2>/dev/null >> vendor/lib64/mt6878/libaibc_tuning_p2.so
rm -f vendor/lib64/mt6878/libaibc_tuning_p2.so.* 2>/dev/null
